<template>
  <v-card class="grey darken-4">
    ...
    <v-icon class="pr-2">copyright</v-icon>
    ...
    async confirmSend() {
      ...
      try {
        ...
        if (res.txId) {
          ...
          this.$root.success(
            `Successful send. You can view at <a href="${txViewUrl}" target="_blank"> <p style=" display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 300px;">${txViewUrl}</a>`,
            true,
            0
          )
        } else {
