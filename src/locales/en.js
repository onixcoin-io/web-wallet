export default {
    common: {
        ...
        menu: {
            ...
            create_from_mnemonic: 'Create New Wallet',
            restore_from_mnemonic: 'Restore From Seed Phrase',
            ...
            dump_as_key_file: 'Download As Key File',
    ...
    file_creator: {
        download: 'Please click this button to start downloading file, if the download did not start, you can right-click the button and choose "save the link as ..."'
    },
    ledger: {
    ...
    create_token: {
        ...
        name: 'Token Name',
        symbol: 'Token Symbol',
        decimal: 'Decimals (It\'s recommended to set decimals to 8 in ONIX)',
    ...
    create_mnemonic: {
        title: 'Generate New Wallet',
        remember: 'Make sure to write down the following words. They are your seed phrases and without them you can\'t access your wallet',
        remembered: 'I have written down. Let\'s verify it'
    },
    restore: {
        title: 'Restore Wallet',
        mnemonic_warning: 'The input words are not bip39 mnemonics. If your address is generated by this wallet, please check your words(no space, no capital letter etc.) and order of the words'
    },
    restore_wif: {
    ...
    restore_ledger: {
        ...
        usage: 'Please ensure your firmware and app are the newest version. Plugin your Ledger, open Onix APP, and then click the "CONNECT" button below try to connect.',
        download: 'No Onix APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
        connect: 'CONNECT'
    },
    view: {
